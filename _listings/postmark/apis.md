...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/filters/master/_listings/postmark/apis.md
...
- name: Postmark - Post Filter
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/filters/master/_listings/postmark/filter-post-openapi.md
- name: Postmark - Post Filter
  x-api-slug: filter-post
  description: 'Postmark???s spam API is a RESTfull interface to the Spam filter tool
    SpamAssassin (http://spamassassin.apache.org/). This can be used to pre or post
