...
- name: Microsoft Graph API - Table Clear Filters
  x-api-slug: workbooktablesltidnamegtclearfilters-post
...
- name: Microsoft Graph API - Table Clear Filters
  x-api-slug: workbookworksheetsltidnamegttablesltidnamegtclearfilters-post
  description: 'Table: clearFilters Clears all the filters currently applied on the
    table.'
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/microsoft-graph.png
  humanURL: https://developer.microsoft.com/en-us/graph/
...
- name: Microsoft Graph API - Table Reapply Filters
  x-api-slug: workbooktablesltidnamegtreapplyfilters-post
...
- name: Microsoft Graph API - Table Reapply Filters
  x-api-slug: workbookworksheetsltidnamegttablesltidnamegtreapplyfilters-post
  description: 'Table: reapplyFilters Reapplies all the filters currently on the table.'
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/microsoft-graph.png
  humanURL: https://developer.microsoft.com/en-us/graph/
  baseURL: https://graph.microsoft.com//
...
- name: Microsoft Graph API - Filter Apply
  x-api-slug: workbooktablesltidnamegtcolumnsltidnamegtfilterapply-post
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/filters/master/_listings/microsoft-graph/workbooktablesltidnamegtcolumnsltidnamegtfilterapply-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/filters/master/_listings/microsoft-graph/workbooktablesltidnamegtcolumnsltidnamegtfilterapply-post-openapi.md
- name: Microsoft Graph API - Filter Apply
  x-api-slug: workbookworksheetsltidnamegttablesltidnamegtcolumnsltidnamegtfilterapply-post
  description: 'Filter: apply Apply the given filter criteria on the given column.'
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/microsoft-graph.png
  humanURL: https://developer.microsoft.com/en-us/graph/
  baseURL: https://graph.microsoft.com//
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/filters/master/_listings/microsoft-graph/workbookworksheetsltidnamegttablesltidnamegtcolumnsltidnamegtfilterapply-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/filters/master/_listings/microsoft-graph/workbookworksheetsltidnamegttablesltidnamegtcolumnsltidnamegtfilterapply-post-openapi.md
- name: Microsoft Graph API - Filter Clear
  x-api-slug: workbooktablesltidnamegtcolumnsltidnamegtfilterclear-post
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/filters/master/_listings/microsoft-graph/workbooktablesltidnamegtcolumnsltidnamegtfilterclear-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/filters/master/_listings/microsoft-graph/workbooktablesltidnamegtcolumnsltidnamegtfilterclear-post-openapi.md
- name: Microsoft Graph API - Filter Clear
  x-api-slug: workbookworksheetsltidnamegttablesltidnamegtcolumnsltidnamegtfilterclear-post
  description: 'Filter: clear Clear the filter on the given column.'
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/microsoft-graph.png
  humanURL: https://developer.microsoft.com/en-us/graph/
  baseURL: https://graph.microsoft.com//
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/filters/master/_listings/microsoft-graph/workbookworksheetsltidnamegttablesltidnamegtcolumnsltidnamegtfilterclear-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/filters/master/_listings/microsoft-graph/workbookworksheetsltidnamegttablesltidnamegtcolumnsltidnamegtfilterclear-post-openapi.md
- name: Microsoft Graph API - Filter Apply
  x-api-slug: workbooktablesltidnamegtcolumnsltidnamegtfilterapply-post
  description: 'Filter: apply Apply the given filter criteria on the given column.'
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/microsoft-graph.png
